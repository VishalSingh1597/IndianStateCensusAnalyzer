...
namespace IndianStateCensusAnalyserTest
{
    public class Tests
    {
        ...
        static string wrongHeaderIndianCensusFile = @"E:\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCensusData.csv";
        //  static string wrongIndianStateCodeFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCode.csv";
        static string IndianStateCodeFiletype = @"E:\IndianCensus\IndianCensus\CSVFiles\IndiaStateCode.txt";
        //  static string delimeterIndianStateCodeFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCode.csv";
        static string delimeterIndianCensusCodeFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCensusData.csv";
