...
namespace IndianStateCensusAnalyserTest
{
    public class TestClass
    {
        ...
        static string indianStateCensusFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\IndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFileType = @"E:\IndianCensus\IndianCensus\CSVFiles\IndiaStateCode.txt";
        static string delimiterIndianCensusData = @"E:\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string headerIndianStateCensusData = @"E:\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCensusData.csv";

        static string indianStateCodeHeader = "﻿SrNo,State Name,TIN,StateCode";
        static string indianStateCodeFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFilePath = @"E:\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianStateCodeFile = @"E:\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCode.csv";
